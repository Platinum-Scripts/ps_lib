...
export const registerMenu: registerMenu = (data, cb) => exports.ps_lib.registerMenu(data, cb);

export const showMenu = (id: string): string => exports.ps_lib.showMenu(id);

export const hideMenu = (onExit: boolean): void => exports.ps_lib.hideMenu(onExit);
...
export const setMenuOptions: setMenuOptions = (id, options, index) => exports.ps_lib.setMenuOptions(id, options, index);
